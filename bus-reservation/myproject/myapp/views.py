...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        try:
            # Query database with case-insensitive filtering
            ...
            if bus_list.exists():
                ...
                context["error"] = "Sorry, no buses available for the given route and date."
        except Exception as e:
            # Catch any unexpected errors
            context["error"] = f"An error occurred: {str(e)}"
    
    # Render the findbus page with error messages or default form
    return render(request, 'myapp/findbus.html', context)
